          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">            
            <div>
              ...
              <input
                ...
                autoComplete="email"
                className={`w-full h-10 px-3.5 text-sm rounded-lg border bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all
                  ${hasError('email')
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full h-10 pl-3.5 pr-10 text-sm rounded-lg border bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all
                    ${hasError('password')
                      ? 'border-red-300 focus:ring-red-200 focus:border-red-400'
                      : 'border-gray-300 focus:ring-blue-100 focus:border-blue-400'
                    }`}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-10 bg-gray-900 hover:bg-gray-800 active:bg-gray-950 
