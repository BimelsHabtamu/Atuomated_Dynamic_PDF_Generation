...
export const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/documents', label: 'Documents', translationKey: 'documentsPage', roles: [SA, SYS, GEN, APP, REC], icon: 'doc' },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/verify-doc', label: 'Verify Document', translationKey: 'verify', roles: [SA, SYS, GEN, APP, REC], icon: 'shield' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/settings', label: 'My Settings', translationKey: 'mySettings', roles: [SA, SYS, GEN, APP, REC], icon: 'cog' },
    ],
  },
];
